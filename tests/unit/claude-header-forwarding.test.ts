...
describe("claudeHeaderCache", () => {
  ...
  beforeEach(async () => {
    ...
    vi.resetModules();
    cacheModule = await import("open-sse/utils/claudeHeaderCache");
  });
...
describe("DefaultExecutor.buildHeaders() — claude provider", () => {
  ...
  beforeEach(async () => {
    ...
    const cache = await import("open-sse/utils/claudeHeaderCache");
    ...
    const mod = await import("open-sse/executors/default");
