...
const { GET } = await import("../../src/app/api/v1beta/models/route");
const { POST } = await import("../../src/app/api/v1beta/models/[...path]/route");
...
describe("Gemini native v1beta endpoint", () => {
  beforeEach(() => {
    ...
    mocks.getApiKeyAccess.mockResolvedValue({ valid: true });
