...
import { toOpenAIFinish, fromOpenAIFinish } from "../../open-sse/translator/concerns/finishReason";
import { OPENAI_FINISH, CLAUDE_STOP, GEMINI_FINISH } from "../../open-sse/translator/schema/finishReasons";
