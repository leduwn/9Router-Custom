...
import { getModelUpstreamId } from "../../open-sse/config/providerModels";
import { AntigravityExecutor } from "../../open-sse/executors/antigravity";
import { applyThinking, stripThinkingSuffix } from "../../open-sse/translator/concerns/thinkingUnified";
import antigravity from "../../open-sse/providers/registry/antigravity";
import geminiCli from "../../open-sse/providers/registry/gemini-cli";
import gemini from "../../open-sse/providers/registry/gemini";
import { MODEL_PRICING } from "../../open-sse/providers/pricing";
import {
...
const mitmConfig = require("../../src/mitm/config");
...
describe("Gemini 3.6 catalogs and pricing", () => {
  ...
  it("keeps the standalone CLI Gemini catalog synchronized", () => {
    const source = readFileSync(join(here, "../../cli/src/cli/menus/providers.ts"), "utf8");
