...
describe("quota auto-ping", () => {
  ...
  beforeEach(async () => {
    ...
    ({ getCodexUsage } = await import("open-sse/services/usage/codex"));
    ({ getClaudeUsage } = await import("open-sse/services/usage/claude"));
    ({ getExecutor } = await import("open-sse/executors/index"));
    ({ runQuotaAutoPingTick, configureQuotaAutoPing } = await import("../../src/shared/services/quotaAutoPing"));
