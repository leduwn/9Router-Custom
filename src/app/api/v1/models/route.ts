...
import { capabilitiesFromServiceKind, getCapabilitiesForModel } from "open-sse/providers/capabilities";
 ...
 */
export async function buildModelsList(kindFilter, options: Record<string, any> = {}) {
