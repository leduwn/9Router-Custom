...
// ── ModelRow ───────────────────────────────────────────────────
export function ModelRow({ model, fullModel, alias: _alias = undefined, copied, onCopy, testStatus, isCustom = false, isFree = false, onDeleteAlias, onSetAlias: _onSetAlias = undefined, onTest, isTesting }) {
