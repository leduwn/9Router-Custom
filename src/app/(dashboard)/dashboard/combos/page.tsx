...
function ComboCard({ combo, getCaps, activeProviders = [], copied, onCopy, onEdit, onDelete, strategy: strategyValue = {}, onSetStrategy }) {
  const strategy: Record<string, any> = strategyValue;
...
function ComboFormModal({ isOpen, combo = null, onClose, onSave, activeProviders, kindFilter = null }) {
