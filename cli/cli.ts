...
function getLanIp() {
  for (const ifaces of Object.values(os.networkInterfaces()) as Array<ReturnType<typeof os.networkInterfaces>[string]>) {
...
const cliRoot = process.env.NINEROUTER_CLI_ROOT
