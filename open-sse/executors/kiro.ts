...
function encodeSSEError(code, message, details = null) {
...
export class KiroExecutor extends BaseExecutor {
  ...
  transformEventStreamToSSE(response, model, options: Record<string, any> = {}) {
    ...
    const sseChunk = (delta, finishReason = null, usage = null) => encoder.encode(`data: ${JSON.stringify({
      id: responseId,
    ...
    const fail = (controller, provenance, code, message, extra: Record<string, any> = {}) => {
      state.finished = true;
