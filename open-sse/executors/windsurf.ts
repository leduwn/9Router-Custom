      ...
      async start(controller) {
        ...
        try {
          ...
          const handleFrame = (flag, payload) => {
            ...
            const executorConstructor: any = executor.constructor;
            const chunk = executorConstructor.decodeCompletionChunk
              ? executorConstructor.decodeCompletionChunk(payload)
