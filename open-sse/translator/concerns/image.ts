 ...
 */
export async function fetchImageAsBase64(imageUrl, options: Record<string, any> = {}) {
  ...
  try {
    ...
    const response = await fetch(imageUrl, { signal: fetchSignal, redirect: "manual", dispatcher } as any);
