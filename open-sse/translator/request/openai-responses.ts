 ...
 */
export function openaiResponsesToOpenAIRequest(model, body, stream, credentials = null) {
...
function buildReasoningInputItem(msg) {
  ...
  const item: Record<string, any> = { type: RESPONSES_ITEM.REASONING };
  if (summaryText) {
 ...
 */
export function openaiToOpenAIResponsesRequest(model, body, stream, credentials = null) {
