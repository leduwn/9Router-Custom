 ...
 */
async function createBypassRequest(parsedUrl, realIP, options): Promise<any> {
...
export async function proxyAwareFetch(url, options: any = {}, proxyOptions: any = null): Promise<any> {
 ...
 */
async function patchedFetch(url, options: any = {}): Promise<any> {
