...
function buildHeaders(accessToken, providerSpecificData: Record<string, any> = {}) {
  const headers = {
...
export async function resolveGrokCliModels(credentials, options: Record<string, any> = {}) {
  const {
