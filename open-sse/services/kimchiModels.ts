...
async function fetchKimchiCatalogRaw(token, endpoint, options: Record<string, any> = {}) {
...
export async function resolveKimchiModels(credentials, options: Record<string, any> = {}) {
