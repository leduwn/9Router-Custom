...
import { stripThinkingSuffix } from "../translator/concerns/thinkingUnified";
import { FORMATS } from "../translator/formats";
import { normalizeClaudePassthrough } from "../translator/formats/claude";
...
import { getModelTargetFormat, getModelStrip, getModelUpstreamId, getModelType, PROVIDER_ID_TO_ALIAS } from "../config/providerModels";
...
import { extractThinking } from "../translator/concerns/thinkingUnified";
 ...
 */
export async function handleChatCore({ body, modelInfo, credentials, log, onCredentialsRefreshed, onRequestSuccess, onDisconnect, clientRawRequest, connectionId, userAgent, apiKey, ccFilterNaming, rtkEnabled, headroomEnabled, headroomUrl, headroomCompressUserMessages, cavemanEnabled, cavemanLevel, ponytailEnabled, ponytailLevel, pxpipeEnabled, pxpipeMinChars, pxpipeTimeoutMs, pxpipeTransform, onPxpipeEvent, sourceFormatOverride, providerThinking }: Record<string, any>): Promise<any> {
  ...
  const headroomDiagnostics: Record<string, any> = {};
