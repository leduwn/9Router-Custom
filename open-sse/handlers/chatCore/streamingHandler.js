 ...
 */
export function buildOnStreamComplete({ provider, model, connectionId, apiKey, requestStartTime, usageDedupeKey, body, stream, finalBody, translatedBody, clientRawRequest, pxpipe, reqTag, log }) {
  ...
  const onStreamComplete = (contentObj, usage, ttftAt) => {
    ...
    saveUsageStats({ provider, model, tokens: usage, connectionId, apiKey, endpoint: clientRawRequest?.endpoint, dedupeKey: usageDedupeKey, label: "STREAM USAGE", silent: true });
