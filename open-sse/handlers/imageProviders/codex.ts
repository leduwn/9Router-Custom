...
async function parseStream(response, log, callbacks: Record<string, any> = {}) {
...
export default {
  ...
  buildBody: (model, body) => {
    ...
    const imgTool: Record<string, any> = { type: "image_generation", output_format: (body.output_format || "png").toLowerCase() };
